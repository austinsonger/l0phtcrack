#ifndef __INC_CWINDOWSIMPORTSETTINGS_H
#define __INC_CWINDOWSIMPORTSETTINGS_H


class CWindowsImportSettings:public QObject, public ILC7Component
{
	Q_OBJECT;
...
public:
	CWindowsImportSettings(ILC7Linkage *pLinkage);
	virtual ~CWindowsImportSettings();
