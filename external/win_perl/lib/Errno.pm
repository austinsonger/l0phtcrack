...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAEPROVIDERFAILEDINIT WSAEREFUSED WSAECANCELLED WSAEWOULDBLOCK
	WSAEUSERS WSAENAMETOOLONG WSAENOTEMPTY WSAESTALE WSAENOMORE
	WSAEHOSTUNREACH WSAEISCONN WSAECONNRESET WSAEINTR WSAEHOSTDOWN
	WSAELOOP WSAEMFILE WSAENOPROTOOPT WSAEINVALIDPROVIDER WSAENOTSOCK
	WSAEALREADY WSAETOOMANYREFS WSAEINVAL WSAEADDRINUSE WSAENETRESET
	WSAECONNABORTED WSAEPROCLIM WSAESOCKTNOSUPPORT WSAEDISCON WSAENOTCONN
	WSAEREMOTE WSAEACCES WSAEDESTADDRREQ WSAEPROTOTYPE
	WSAEINVALIDPROCTABLE WSAEAFNOSUPPORT WSAEFAULT WSAENETUNREACH
	WSAETIMEDOUT WSAENOBUFS WSAEMSGSIZE WSAEBADF WSAEADDRNOTAVAIL
	WSAEDQUOT WSAECONNREFUSED WSAEOPNOTSUPP WSAEINPROGRESS WSAENETDOWN
	WSAEPFNOSUPPORT WSAEPROTONOSUPPORT WSAESHUTDOWN
    )],
);
