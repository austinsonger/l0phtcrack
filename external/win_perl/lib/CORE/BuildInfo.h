/* BuildInfo.h
 *
 * Copyright (C) 1998-2017 ActiveState Corp.  All rights reserved.
 *
 */
...
#define ACTIVEPERL_VERSION      2601
#define ACTIVEPERL_SUBVERSION   0
#define ACTIVEPERL_CHANGELIST   " [404865]"
...
#endif
#define PERLFILEVERSION		"5,26,1," STRINGIFY(ACTIVEPERL_VERSION) "\0"
#define PERLRC_VERSION		5,26,1,ACTIVEPERL_VERSION
