...
struct JTRPASSNODE
{
	...
	JTRPASSNODE() { node = 0xCCCCCCCC; nodecount = 0xCCCCCCCC; gpu_enable = (bool)0xCC; gpu_platform = (GPUPLATFORM)0xCCCCCCCC; gpu_jtrindex = 0xCCCCCCCC; }
