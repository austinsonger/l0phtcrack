#ifndef __INC_REPORTEXPORTACCOUNTSGUI_H
#define __INC_REPORTEXPORTACCOUNTSGUI_H

#include"../../lc7/include/ILC7GUIComponent.h"

class CLC7ReportExportAccountsGUI :public QObject, public ILC7Component
{
	Q_OBJECT;
...
public:
	CLC7ReportExportAccountsGUI();
	virtual ~CLC7ReportExportAccountsGUI();
