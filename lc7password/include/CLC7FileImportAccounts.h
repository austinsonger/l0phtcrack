#ifndef __INC_FILEIMPORTACCOUNTS_H
#define __INC_FILEIMPORTACCOUNTS_H

class CLC7FileImportAccounts :public QObject, public ILC7Component
{
	Q_OBJECT;
...
public:
	CLC7FileImportAccounts();
	virtual ~CLC7FileImportAccounts();
