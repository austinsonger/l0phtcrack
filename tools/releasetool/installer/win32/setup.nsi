...
notRunning:
    ...
    MessageBox MB_YESNO|MB_DEFBUTTON2 "Do you want to completely remove all L0phtCrack application data? This will remove any historical data, registry entries and settings used by the program. This will not remove your active license from this machine if it is activated." /SD IDNO IDNO noDeleteData
        ...
        RmDir /r "$APPDATA\L0pht Holdings LLC\L0phtCrack 7 (Win32)"
        RmDir "$APPDATA\L0pht Holdings LLC"
        RmDir /r "$LOCALAPPDATA\L0pht Holdings LLC\L0phtCrack 7 (Win32)"
...
Function .onInit
    ...
    ${If} ${RunningX64}
        ...
        MessageBox MB_OK|MB_ICONEXCLAMATION "L0phtCrack 7 is available in a 64-bit version, which has better performance on your hardware. Consider downloading the 64-bit version from http://www.l0phtcrack.com" /SD IDOK
